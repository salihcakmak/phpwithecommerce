<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
	<tr height="75" bgcolor="#FF9900">
		<td align="center"><h2 style="color: white;">BANKA HESAPLARIMIZ</h2></td>
	</tr>
	<tr height="50">
		<td align="left" style="border-bottom: 1px solid #CCCCCC;">&nbsp;Ödemeleriniz İçin Çalışmakta Olduğumuz Tüm Banka Hesap Bilgileri Aşağıdadır.</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	</tr>
	...
	<tr>
		<td>
			<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<?php
					$BankalarSorgu 	= $dbConnection->prepare("Select * From bankahesaplarimiz");
					$BankalarSorgu->execute();
					$BankaSayisi 	= $BankalarSorgu->rowCount();
					$BankaKayitlari = $BankalarSorgu->fetchAll(PDO::FETCH_ASSOC);
					...
					<td width="348">
						<table align="center" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #CCCCCC; margin-bottom: 10px;">
							<tr height="40">
								<td colspan="4" align="center"><img src="images/<?php echo DonusumleriGeriDondur($Kayit["BankaLogosu"]); ?>" border="0"></td>
							</tr>
							<tr height="25">
								<td width="5">&nbsp;</td>
