	...
	<tr>
		<td width="1065" valign="top">
			<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
				...
				<tr height="30">
					<td colspan="2" valign="top" style="border-bottom: 1px solid #CCCCCC;">Tüm Yorumlarınız Bu Alandan Görüntüleyebilirsiniz.</td>
				</tr>
				<tr height="50">
				...
				<?php
				$YorumlarSorgusu		=	$dbConnection->prepare("SELECT * FROM yorumlar WHERE UyeId = ? ORDER BY YorumTarihi DESC LIMIT $SayfalamayaBaslanacakKayitSayisi, $SayfaBasinaGosterilecekKayitSayisi");
				...
				?>
						<tr>
							<td width="85" align="left" style="border-bottom: 1px solid #CCCCCC; padding: 15px 0px;" valign="top"><img src="images/<?php echo $ResimDosyasi; ?>" border="0"></td>
							<td width="980" align="left" style="border-bottom: 1px solid #CCCCCC; padding: 15px 0px;" valign="top"><?php echo DonusumleriGeriDondur($Satirlar["YorumMetni"]); ?></td>
						</tr>
				<?php	
						}
