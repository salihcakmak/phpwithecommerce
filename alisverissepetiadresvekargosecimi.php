		...
		<tr>
			<td width="800" valign="top">
				<table width="800" align="center" border="0" cellpadding="0" cellspacing="0">
					...
					<tr height="30">
						<td colspan="2" valign="top" style="border-bottom: 1px solid #CCCCCC;">Adres ve Kargo Seçimini Aşağıdan Belirtebilirsin.</td>
					</tr>
					<tr height="10">
								...
								?>
									<td width="260">
										<table width="260" align="center" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #CCCCCC; margin-bottom: 10px;">
											...
											<tr height="40">
												<td align="center"><img src="images/<?php echo DonusumleriGeriDondur($KargoKaydi["KargoFirmasiLogosu"]); ?>" border="0"></td>
											</tr>
											<tr>
