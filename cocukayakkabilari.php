...
$AnaMenununTumUrunSayiSorgusu		=	$dbConnection->prepare("SELECT SUM(UrunSayisi) AS MenununToplamUrunu FROM menuler WHERE UrunTuru = 'Çocuk Ayakkabısı'");
						...
						?>
							...
							<td width="191" valign="top">
								<table width="191" align="left" border="0" cellpadding="0" cellspacing="0" style="margin-bottom: 10px;"> <!-- border: 1px solid #CCCCCC; -->
									<tr height="40">
										<td align="center"><a href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($Kayit["id"]); ?>"><img src="images/UrunResimleri/Cocuk/<?php echo DonusumleriGeriDondur($Kayit["UrunResmiBir"]); ?>" border="0" width="185" height="247"></a></td>
									</tr>
									<tr height="25">
									...
									<tr height="25">
										<td width="191" align="center"><a href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($Kayit["id"]); ?>"><img src="images/<?php echo $PuanResmi; ?>" border="0"></a></td>
									</tr>
									<tr height="25">
