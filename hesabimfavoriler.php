	...
	<tr>
		<td width="1065" valign="top">
			<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
				...
				<tr height="30">
					<td colspan="4" valign="top" style="border-bottom: 1px solid #CCCCCC;">Favorilerinize Eklediğiniz Tüm Ürünleri Bu Alandan Görüntüleyebilirsiniz.</td>
				</tr>
				<tr height="50">
				...
				?>
						<tr height="30">
							<td width="75" align="left" style="border-bottom: 1px solid #CCCCCC;"><a href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($UrunKaydi["id"]); ?>"><img src="images/UrunResimleri/<?php echo $ResimKlasoruAdi; ?>/<?php echo DonusumleriGeriDondur($UrununResmi); ?>" border="0" width="60" height="80"></a></td>
							<td width="50" align="left" style="border-bottom: 1px solid #CCCCCC;"><a href="index.php?SK=81&ID=<?php echo DonusumleriGeriDondur($FavoriSatirlar["id"]); ?>"><img src="images/Sil20x20.png" border="0"></a></td>
							<td width="415" align="left" style="border-bottom: 1px solid #CCCCCC;"><a href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($UrunKaydi["id"]); ?>" style="color: #646464; text-decoration: none;"><?php echo DonusumleriGeriDondur($UrununAdi); ?></a></td>
							<td width="100" align="left" style="border-bottom: 1px solid #CCCCCC;"><a href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($UrunKaydi["id"]); ?>" style="color: #646464; text-decoration: none;"><?php echo FiyatBicimlendir(DonusumleriGeriDondur($UrununUrunFiyati)); ?> <?php echo DonusumleriGeriDondur($UrununParaBirimi); ?></a></td>
						</tr>
				<?php	
					}
