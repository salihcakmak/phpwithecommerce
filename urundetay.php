...
$UrunHitiGuncellemeSorgusu	=	$dbConnection->prepare("UPDATE urunler SET GoruntulenmeSayisi=GoruntulenmeSayisi+1 WHERE id = ? AND Durumu = ? LIMIT 1");
...
<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td width="350" valign="top"><table width="350" align="center" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td style="border: 1px solid #CCCCCC;" align="center"><img id="BuyukResim" src="images/UrunResimleri/<?php echo $ResimKlasoru; ?>/<?php echo DonusumleriGeriDondur($UrunSorgusuKaydi["UrunResmiBir"]); ?>" width="330" height="440" border="0"></td>
			</tr>
			<tr height="5">
			...
			<tr>
				<td><table width="350" align="center" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td width="78" style="border: 1px solid #CCCCCC;"><img src="images/UrunResimleri/<?php echo $ResimKlasoru; ?>/<?php echo DonusumleriGeriDondur($UrunSorgusuKaydi["UrunResmiBir"]); ?>" width="78" height="104" border="0" onClick="$.UrunDetayResmiDegistir('<?php echo $ResimKlasoru; ?>', '<?php echo DonusumleriGeriDondur($UrunSorgusuKaydi["UrunResmiBir"]); ?>');"></td>
						<td width="10">&nbsp;</td>
						<?php if(DonusumleriGeriDondur($UrunSorgusuKaydi["UrunResmiIki"])!=""){ ?><td width="78" style="border: 1px solid #CCCCCC;"><img src="images/UrunResimleri/<?php echo $ResimKlasoru; ?>/<?php echo DonusumleriGeriDondur($UrunSorgusuKaydi["UrunResmiIki"]); ?>" width="78" height="104" border="0" onClick="$.UrunDetayResmiDegistir('<?php echo $ResimKlasoru; ?>', '<?php echo DonusumleriGeriDondur($UrunSorgusuKaydi["UrunResmiIki"]); ?>');"></td><?php }else{ ?><td width="78">&nbsp;</td><?php } ?>
						<td width="10">&nbsp;</td>
						<?php if(DonusumleriGeriDondur($UrunSorgusuKaydi["UrunResmiUc"])!=""){ ?><td width="78" style="border: 1px solid #CCCCCC;"><img src="images/UrunResimleri/<?php echo $ResimKlasoru; ?>/<?php echo DonusumleriGeriDondur($UrunSorgusuKaydi["UrunResmiUc"]); ?>" width="78" height="104" border="0" onClick="$.UrunDetayResmiDegistir('<?php echo $ResimKlasoru; ?>', '<?php echo DonusumleriGeriDondur($UrunSorgusuKaydi["UrunResmiUc"]); ?>');"></td><?php }else{ ?><td width="78">&nbsp;</td><?php } ?>
						<td width="10">&nbsp;</td>
						<?php if(DonusumleriGeriDondur($UrunSorgusuKaydi["UrunResmiDort"]!="")){ ?><td width="78" style="border: 1px solid #CCCCCC;"><img src="images/UrunResimleri/<?php echo $ResimKlasoru; ?>/<?php echo DonusumleriGeriDondur($UrunSorgusuKaydi["UrunResmiDort"]); ?>" width="78" height="104" border="0" onClick="$.UrunDetayResmiDegistir('<?php echo $ResimKlasoru; ?>', '<?php echo DonusumleriGeriDondur($UrunSorgusuKaydi["UrunResmiDort"]); ?>');"></td><?php }else{ ?><td width="78">&nbsp;</td><?php } ?>
					</tr>
				</table></td>
			</tr>
			<tr>
			...
			<tr>
				<td><table width="350" align="center" border="0" cellpadding="0" cellspacing="0">
					...
					?>
					<tr height="350">
						<td><img src="images/<?php echo DonusumleriGeriDondur($BannerKaydi["BannerResmi"]); ?>" border="0"></td>
					</tr>
					<?php
		...
		<td width="705" valign="top"><table width="705" align="center" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td><form action="index.php?SK=91&ID=<?php echo DonusumleriGeriDondur($UrunSorgusuKaydi["id"]); ?>" method="post"><table width="705" align="center" border="0" cellpadding="0" cellspacing="0">
					<tr height="45">
						<td width="30"><a href="<?php echo DonusumleriGeriDondur($SosyalLinkFacebook); ?>" target="_blank"><img src="images/Facebook24x24.png" border="0" style="margin-top: 5px;"></a></td>
						<td width="30"><a href="<?php echo DonusumleriGeriDondur($SosyalLinkTwitter); ?>" target="_blank"><img src="images/Twitter24x24.png" border="0" style="margin-top: 5px;"></a></td>
						<td width="30"><?php if(isset($_SESSION["Kullanici"])){ ?><a href="index.php?SK=87&ID=<?php echo DonusumleriGeriDondur($UrunSorgusuKaydi["id"]); ?>"><img src="images/KalpKirmiziDaireliBeyaz24x24.png" border="0" style="margin-top: 5px;"></a><?php }else{ ?><img src="images/KalpKirmiziDaireliBeyaz24x24.png" border="0" style="margin-top: 5px;"><?php } ?></td>
						<td width="10">&nbsp;</td>
						...
						<td colspan="5"><table width="705" align="center" border="0" cellpadding="0" cellspacing="0">
							<tr height="45">
								<td width="500" align="left"><select name="Varyant" class="SelectAlanlari">
									...
									$VaryantSorgusu		=	$dbConnection->prepare("SELECT * FROM urunvaryantlari WHERE UrunId = ? AND StokAdedi > ? ORDER BY VaryantAdi ASC");
			...
			<tr>
				<td><div style="width: 705px; max-width: 705px; height: 300px; max-height: 300px; overflow-y: scroll;"><table width="685" align="left" border="0" cellpadding="0" cellspacing="0">
					...
					?>
							<tr height="30">
								<td width="64"><img src="images/<?php echo $YorumPuanResmi; ?>" border="0"></td>
								<td width="10">&nbsp;</td>
