...
<table width="760" align="center" border="0" cellpadding="0" cellspacing="0">
	...
	<?php
	$SiparisNumaralariSorgusu		=	$dbConnection->prepare("SELECT DISTINCT SiparisNumarasi FROM siparisler WHERE OnayDurumu = ? AND KargoDurumu = ? ORDER BY id ASC");
				...
				<td colspan="2" style="border-bottom: 1px dashed #CCCCCC;" valign="top"><table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
					<tr height="30">
						...
						<td align="left" width="130"><table width="130" align="right" border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td width="25"><a href="index.php?SKD=0&SKI=113&SiparisNo=<?php echo DonusumleriGeriDondur($SiparisNumaralariSatirlar["SiparisNumarasi"]); ?>"><img src="../images/Sil20x20.png" border="0" style="margin-top: 5px;"></a></td>
								...
								<td width="25"><a href="index.php?SKD=0&SKI=107&SiparisNo=<?php echo DonusumleriGeriDondur($SiparisNumaralariSatirlar["SiparisNumarasi"]); ?>"><img src="../images/DokumanKirmiziKalemli20x20.png" border="0" style="margin-top: 5px;"></a></td>
