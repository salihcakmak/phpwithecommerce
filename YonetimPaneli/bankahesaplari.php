...
<table width="760" align="center" border="0" cellpadding="0" cellspacing="0">
	...
	<?php
	$HesaplarSorgusu		=	$dbConnection->prepare("SELECT * FROM bankahesaplarimiz ORDER BY BankaAdi ASC");
		...
		<td colspan="2" style="border-bottom: 1px dashed #CCCCCC;" valign="top"><table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td width="200"><table width="200" align="right" border="0" cellpadding="0" cellspacing="0">
					<tr height="75">
						<td><img src="../images/<?php echo DonusumleriGeriDondur($Hesaplar["BankaLogosu"]); ?>" border="0"></td>
					</tr>
					<tr height="30">
						<td align="left"><table width="200" align="right" border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td width="25" valign="top"><a href="index.php?SKD=0&SKI=14&ID=<?php echo DonusumleriGeriDondur($Hesaplar["id"]); ?>"><img src="../images/Guncelleme20x20.png" border="0"></a></td>
								...
								<td width="25" valign="top"><a href="index.php?SKD=0&SKI=18&ID=<?php echo DonusumleriGeriDondur($Hesaplar["id"]); ?>"><img src="../images/Sil20x20.png" border="0"></a></td>
