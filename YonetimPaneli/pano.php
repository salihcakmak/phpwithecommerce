...
if(isset($_SESSION["Yonetici"])){
	...
	$TumSiparislerSorgusu			=	$dbConnection->prepare("SELECT DISTINCT SiparisNumarasi FROM siparisler");
	$TumSiparislerSorgusu->execute();
	$TumSiparislerSayisi			=	$TumSiparislerSorgusu->rowCount();
	
	$HavaleBildirimSorgusu			=	$dbConnection->prepare("SELECT * FROM havalebildirimleri");
...
<table width="760" align="center" border="0" cellpadding="0" cellspacing="0">
	<tr height="70">
		<td bgcolor="#FF9900" style="color: #FFFFFF;" align="left"><h3>&nbsp;DASHBOARD</h3></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	</tr>
