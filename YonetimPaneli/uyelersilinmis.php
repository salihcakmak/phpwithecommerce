...
if(isset($_SESSION["Yonetici"])){
	...
	$ToplamKayitSayisiSorgusu				=	$dbConnection->prepare("SELECT * FROM uyeler WHERE SilinmeDurumu = ? $AramaKosulu ORDER BY id DESC");
...
<table width="760" align="center" border="0" cellpadding="0" cellspacing="0">
	...
	<?php
	$UyelerSorgusu		=	$dbConnection->prepare("SELECT * FROM uyeler WHERE SilinmeDurumu = ? $AramaKosulu ORDER BY id DESC LIMIT $SayfalamayaBaslanacakKayitSayisi, $SayfaBasinaGosterilecekKayitSayisi");
				...
				<td colspan="2" style="border-bottom: 1px dashed #CCCCCC;" valign="top"><table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td colspan="9" align="right"><table width="95" align="right" border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td width="20">&nbsp;</td>
								<td width="25" valign="top" align="left"><a href="index.php?SKD=0&SKI=87&ID=<?php echo DonusumleriGeriDondur($Uyeler["id"]); ?>"><img src="../images/Guncelleme20x20.png" border="0" style="margin-top: 5px;"></a></td>
