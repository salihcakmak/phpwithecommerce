...
<table width="760" align="center" border="0" cellpadding="0" cellspacing="0">
	...
	<?php
	$BannerlarSorgusu		=	$dbConnection->prepare("SELECT * FROM bannerlar ORDER BY id DESC");
	...
	<tr height="40">
		<td colspan="2" style="border-bottom: 1px dashed #CCCCCC;" valign="top"><table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
			<tr height="40">
				<td width="175" align="left"><img src="../images/<?php echo DonusumleriGeriDondur($Bannerlar["BannerResmi"]); ?>" border="0" height="30"></td>
				...
				<td width="575" align="left"><table width="575" align="right" border="0" cellpadding="0" cellspacing="0">
					...
					<tr height="20">
						<td colspan="9"><table width="575" align="right" border="0" cellpadding="0" cellspacing="0">
							<tr height="20">
								<td width="425">&nbsp;</td>
								<td width="25" valign="top" align="left"><a href="index.php?SKD=0&SKI=38&ID=<?php echo DonusumleriGeriDondur($Bannerlar["id"]); ?>"><img src="../images/Guncelleme20x20.png" border="0" style="margin-top: 5px;"></a></td>
								...
								<td width="25" valign="top" align="left"><a href="index.php?SKD=0&SKI=42&ID=<?php echo DonusumleriGeriDondur($Bannerlar["id"]); ?>"><img src="../images/Sil20x20.png" border="0" style="margin-top: 5px;"></a></td>
