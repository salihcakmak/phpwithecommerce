...
<table width="760" align="center" border="0" cellpadding="0" cellspacing="0">
	...
	<?php
	$DestekSorgusu		=	$dbConnection->prepare("SELECT * FROM sorular ORDER BY soru ASC");
		...
		<td colspan="2" style="border-bottom: 1px dashed #CCCCCC;" valign="top"><table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
			...
			<tr height="20">
				<td align="right"><table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
					<tr height="20">
						<td width="600">&nbsp;</td>
						<td width="25" valign="top" align="left"><a href="index.php?SKD=0&SKI=50&ID=<?php echo DonusumleriGeriDondur($Destek["id"]); ?>"><img src="../images/Guncelleme20x20.png" border="0" style="margin-top: 5px;"></a></td>
						...
						<td width="25" valign="top" align="left"><a href="index.php?SKD=0&SKI=54&ID=<?php echo DonusumleriGeriDondur($Destek["id"]); ?>"><img src="../images/Sil20x20.png" border="0" style="margin-top: 5px;"></a></td>
