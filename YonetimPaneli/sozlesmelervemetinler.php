	...
	<table width="760" align="center" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td><table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td width="230" valign="top"><b>Hakkımızda Metni</b></b></td>
				...
				<tr>
					<td width="230" valign="top"><b>Üyelik Sözleşmesi Metni</b></td>
					<td width="20" valign="top">:</td>
				...
				<tr>
					<td width="230" valign="top"><b>Kullanım Koşulları Metni</b></td>
					<td width="20" valign="top">:</td>
				...
				<tr>
					<td width="230" valign="top"><b>Gizlilik Sözleşmesi Metni</b></td>
					<td width="20" valign="top">:</td>
				...
				<tr>
					<td width="230" valign="top"><b>Mesafeli Satış Sözleşmesi Metni</b></td>
					<td width="20" valign="top">:</td>
				...
				<tr>
					<td width="230" valign="top"><b>Teslimat Metni</b></td>
					<td width="20" valign="top">:</td>
				...
				<tr>
					<td width="230" valign="top"><b>İptal & İade & Değişim Metni</b></td>
					<td width="20" valign="top">:</td>
