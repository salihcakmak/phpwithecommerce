...
<table width="760" align="center" border="0" cellpadding="0" cellspacing="0">
	...
	if($UrunlerSayisi>0){
		foreach($UrunlerKayitlari as $Urunler){
			$UrununMenuSorgusu		=	$dbConnection->prepare("SELECT * FROM menuler WHERE id = ? LIMIT 1");
	...
	<tr height="80">
		<td colspan="2" style="border-bottom: 1px dashed #CCCCCC;" valign="top"><table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td width="60" valign="top"><img src="../images/UrunResimleri/<?php echo $ResimKlasoru; ?>/<?php echo DonusumleriGeriDondur($Urunler["UrunResmiBir"]); ?>" border="0" width="60" height="80"></td>
				<td width="10">&nbsp;</td>
				<td width="680" valign="top"><table width="680" align="right" border="0" cellpadding="0" cellspacing="0">
					...
					<tr height="25">
						...
						<td width="140" align="right"><table width="140" align="right" border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td width="25" valign="top"><a href="index.php?SKD=0&SKI=99&ID=<?php echo DonusumleriGeriDondur($Urunler["id"]); ?>"><img src="../images/Guncelleme20x20.png" border="0"></a></td>
								...
								<td width="25" valign="top"><a href="index.php?SKD=0&SKI=103&ID=<?php echo DonusumleriGeriDondur($Urunler["id"]); ?>"><img src="../images/Sil20x20.png" border="0"></a></td>
