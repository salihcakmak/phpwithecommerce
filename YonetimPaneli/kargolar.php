...
<table width="760" align="center" border="0" cellpadding="0" cellspacing="0">
	...
	<tr height="50">
		<td colspan="2" style="border-bottom: 1px dashed #CCCCCC;" valign="top"><table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
			<tr height="50">
				<td width="200" align="left"><img src="../images/<?php echo DonusumleriGeriDondur($Kargolar["KargoFirmasiLogosu"]); ?>" border="0"></td>
				...
				<td width="10" align="left">&nbsp;</td>
				<td width="25" valign="top" align="left"><a href="index.php?SKD=0&SKI=26&ID=<?php echo DonusumleriGeriDondur($Kargolar["id"]); ?>"><img src="../images/Guncelleme20x20.png" border="0" style="margin-top: 15px;"></a></td>
				...
				<td width="25" valign="top" align="left"><a href="index.php?SKD=0&SKI=30&ID=<?php echo DonusumleriGeriDondur($Kargolar["id"]); ?>"><img src="../images/Sil20x20.png" border="0" style="margin-top: 15px;"></a></td>
