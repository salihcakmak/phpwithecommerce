...
<table width="760" align="center" border="0" cellpadding="0" cellspacing="0">
	...
	if($BildirimSayisi>0){
		foreach($BildirimKayitlari as $Bildirimler){
			$BankaSorgusu		=	$dbConnection->prepare("SELECT * FROM bankahesaplarimiz WHERE id = ? LIMIT 1");
		...
		<td style="border-bottom: 1px dashed #CCCCCC;" valign="top"><table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
			...
			<tr height="20">
				<td colspan="3" align="right"><table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
					<tr height="20">
						<td width="695">&nbsp;</td>
						<td width="25" valign="top" align="left"><a href="index.php?SKD=0&SKI=117&ID=<?php echo DonusumleriGeriDondur($Bildirimler["id"]); ?>"><img src="../images/Sil20x20.png" border="0" style="margin-top: 5px;"></a></td>
