		...
		<td colspan="2" style="border-bottom: 1px dashed #CCCCCC;" valign="top"><table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
			<tr height="30">
				...
				<td align="right" width="150"><table width="150" align="right" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td width="25" valign="top" align="left"><a href="index.php?SKD=0&SKI=75&ID=<?php echo DonusumleriGeriDondur($YoneticilerSatirlari["id"]); ?>"><img src="../images/Guncelleme20x20.png" border="0" style="margin-top: 5px;"></a></td>
						...
						<td width="25" valign="top" align="left"><a href="index.php?SKD=0&SKI=79&ID=<?php echo DonusumleriGeriDondur($YoneticilerSatirlari["id"]); ?>"><img src="../images/Sil20x20.png" border="0" style="margin-top: 5px;"></a></td>
