...
if(isset($_SESSION["Yonetici"])){
	...
	if(($GelenHakkimizdaMetni!="") and ($GelenUyelikSozlesmesiMetni!="") and ($GelenKullanimKosullariMetni!="") and ($GelenGizlilikSozlesmesiMetni!="") and ($GelenMesafeliSatisSozlesmesiMetni!="") and ($GelenTeslimatMetni!="")){
		$MetinleriGuncelle			=	$dbConnection->prepare("UPDATE sozlesmelervemetinler SET HakkimizdaMetni = ?, UyelikSozlesmesiMetni = ?, KullanimKosullariMetni = ?, GizlilikSozlesmesiMetni = ?, MesafeliSatisSozlesmesiMetni = ?, TeslimatMetni = ?, IptalIadeDegisimMetni = ?");
