...
if(isset($_SESSION["Yonetici"])){
	...
	$ToplamKayitSayisiSorgusu				=	$dbConnection->prepare("SELECT * FROM yorumlar ORDER BY id DESC");
...
<table width="760" align="center" border="0" cellpadding="0" cellspacing="0">
	...
	<?php
	$YorumlarSorgusu		=	$dbConnection->prepare("SELECT * FROM yorumlar ORDER BY id DESC LIMIT $SayfalamayaBaslanacakKayitSayisi, $SayfaBasinaGosterilecekKayitSayisi");
	...
	?>	
			<tr>
				<td style="border-bottom: 1px dashed #CCCCCC;" valign="top"><table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td width="685"><img src="../images/<?php echo $PuanResmi ?>" border="0"></td>
						<td width="10">&nbsp;</td>
						<td width="55"><table width="55" align="right" border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td width="25" valign="top" align="left"><a href="index.php?SKD=0&SKI=91&ID=<?php echo DonusumleriGeriDondur($Yorumlar["id"]); ?>"><img src="../images/Sil20x20.png" border="0" style="margin-top: 5px;"></a></td>
