...
$ToplamKayitSayisiSorgusu				=	$dbConnection->prepare("SELECT DISTINCT SiparisNumarasi FROM siparisler WHERE UyeId = ? ORDER BY SiparisNumarasi DESC");
	...
	<tr>
		<td width="1065" valign="top">
			<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
				...
				<tr height="30">
					<td colspan="8" valign="top" style="border-bottom: 1px solid #CCCCCC;">Tüm Siparişlerinizi Bu Alandan Görüntüleyebilirsiniz.</td>
				</tr>
				<tr height="50">
				...
				<?php
				$SiparisNumaralariSorgusu		=	$dbConnection->prepare("SELECT DISTINCT SiparisNumarasi FROM siparisler WHERE UyeId = ? ORDER BY SiparisNumarasi DESC LIMIT $SayfalamayaBaslanacakKayitSayisi, $SayfaBasinaGosterilecekKayitSayisi");
				...
				?>
							<tr height="30">
								...
								<td width="75" align="left"><img src="images/UrunResimleri/<?php echo $ResimKlasoruAdi; ?>/<?php echo DonusumleriGeriDondur($SiparisSatirlar["UrunResmiBir"]); ?>" border="0" width="60" height="80"></td>
								<td width="50" align="left"><a href="index.php?SK=75&UrunID=<?php echo DonusumleriGeriDondur($SiparisSatirlar["UrunId"]); ?>"><img src="images/DokumanKirmiziKalemli20x20.png" border="0"></a></td>
