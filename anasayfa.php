<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td><table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
			<?php
			$BannerSorgusu		=	$dbConnection->prepare("SELECT * FROM bannerlar WHERE BannerAlani = 'Ana Sayfa' ORDER BY GosterimSayisi ASC LIMIT 1");
			$BannerSorgusu->execute();
			$BannerSayisi		=	$BannerSorgusu->rowCount();
			$BannerKaydi		=	$BannerSorgusu->fetch(PDO::FETCH_ASSOC);
			?>
			<tr height="186">
				<td><img src="images/<?php echo $BannerKaydi["BannerResmi"]; ?>" border="0"></td>
			</tr>
			<?php
				...
				?>
					<td width="205" valign="top">
						<table width="205" align="left" border="0" cellpadding="0" cellspacing="0" style="margin-bottom: 10px;">
							<tr height="40">
								<td align="center"><a href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($EnYeniUrunSatirlari["id"]); ?>"><img src="images/UrunResimleri/<?php echo $EnYeniUrunResimKlasoru; ?>/<?php echo DonusumleriGeriDondur($EnYeniUrunSatirlari["UrunResmiBir"]); ?>" border="0" width="205" height="273"></a></td>
							</tr>
							<tr height="25">
							...
							<tr height="25">
								<td width="205" align="center"><a href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($EnYeniUrunSatirlari["id"]); ?>"><img src="images/<?php echo $EnYeniPuanResmi; ?>" border="0"></a></td>
							</tr>
							<tr height="25">
			...
			<tr><?php
				...
				?>
					<td width="205" valign="top">
						<table width="205" align="left" border="0" cellpadding="0" cellspacing="0" style="margin-bottom: 10px;">
							<tr height="40">
								<td align="center"><a href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($EnPopulerUrunSatirlari["id"]); ?>"><img src="images/UrunResimleri/<?php echo $EnPopulerUrunResimKlasoru; ?>/<?php echo DonusumleriGeriDondur($EnPopulerUrunSatirlari["UrunResmiBir"]); ?>" border="0" width="205" height="273"></a></td>
							</tr>
							<tr height="25">
							...
							<tr height="25">
								<td width="205" align="center"><a href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($EnPopulerUrunSatirlari["id"]); ?>"><img src="images/<?php echo $EnPopulerPuanResmi; ?>" border="0"></a></td>
							</tr>
							<tr height="25">
			...
			<tr><?php
				...
				?>
					<td width="205" valign="top">
						<table width="205" align="left" border="0" cellpadding="0" cellspacing="0" style="margin-bottom: 10px;">
							<tr height="40">
								<td align="center"><a href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($EnCokSatanUrunSatirlari["id"]); ?>"><img src="images/UrunResimleri/<?php echo $EnCokSatanUrunResimKlasoru; ?>/<?php echo DonusumleriGeriDondur($EnCokSatanUrunSatirlari["UrunResmiBir"]); ?>" border="0" width="205" height="273"></a></td>
							</tr>
							<tr height="25">
							...
							<tr height="25">
								<td width="205" align="center"><a href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($EnCokSatanUrunSatirlari["id"]); ?>"><img src="images/<?php echo $EnCokSatanPuanResmi; ?>" border="0"></a></td>
							</tr>
							<tr height="25">
