<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td width="500" valign="top">
			<form action="index.php?SK=17" method="post">
				<table width="500" align="center" border="0" cellpadding="0" cellspacing="0">
					...
					<tr height="30">
						<td valign="top" style="border-bottom: 1px solid #CCCCCC;">Bir Sorunuzmu Var? Bizlere Her Konuda Yazabilirsiniz.</td>
					</tr>
					<tr height="30">
		...
		<td width="545" valign="top"><table width="545" align="center" border="0" cellpadding="0" cellspacing="0">
			...
			<tr height="30">
				<td colspan="2" valign="top" style="border-bottom: 1px solid #CCCCCC;">Geçersiz Gördüğümüz Mesajlar Aşağıdaki Şekildedir.</td>
			</tr>
			<tr height="5">
				<td colspan="2" height="5" style="font-size: 5px;">&nbsp;</td>
			</tr>
			<tr height="30">
				<td align="left" width="30"><img src="images/DokumanKirmiziKalemli20x20.png" border="0" style="margin-top: 3px;"></td>
			...
			<tr height="30">
				<td align="left" width="30"><img src="images/UcuncuSahislar20x20.png" border="0" style="margin-top: 3px;"></td>
			...
			<tr height="30">
				<td align="left" width="30"><img src="images/HedefMaviOkSiyah20x20.png" border="0" style="margin-top: 3px;"></td>
			...
			<tr height="30">
				<td align="left" width="30"><img src="images/InsanlarSiyah20x20.png" border="0" style="margin-top: 3px;"></td>
