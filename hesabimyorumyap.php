...
<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td width="500" valign="top">
			<form action="index.php?SK=76&UrunID=<?php echo $GelenUrunID; ?>" method="post">
				<table width="500" align="center" border="0" cellpadding="0" cellspacing="0">
					...
					<tr height="30">
						<td valign="top" style="border-bottom: 1px solid #CCCCCC;">Satın Almış olduğunuz Ürün İle Alakalı Aşağıdan Yorumunu Belirtebilirsin.</td>
					</tr>
					<tr height="30">
		...
		<td width="545" valign="top"><table width="545" align="center" border="0" cellpadding="0" cellspacing="0">
			...
			<tr height="30">
				<td valign="top" style="border-bottom: 1px dashed #CCCCCC;">Google Reklamları.</td>
			</tr>
			<tr height="5">
				<td height="5" style="font-size: 5px;">&nbsp;</td>
			</tr>
			<tr>
				<td><img src="images/545x340Reklam.jpg" border="0"></td>
			</tr>
		</table></td>
	</tr>
</table>	
