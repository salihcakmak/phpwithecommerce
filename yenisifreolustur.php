...
if(($GelenAktivasyonKodu!="") and ($GelenEmail!="")){
	$KontrolSorgusu		=	$dbConnection->prepare("SELECT * FROM uyeler WHERE EmailAdresi = ? AND AktivasyonKodu = ?");
...
<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td width="500" valign="top">
			<form action="index.php?SK=44&EmailAdresi=<?php echo $GelenEmail; ?>&AktivasyonKodu=<?php echo $GelenAktivasyonKodu; ?>" method="post">
				<table width="500" align="center" border="0" cellpadding="0" cellspacing="0">
					...
					<tr height="30">
						<td colspan="2" valign="top" style="border-bottom: 1px solid #CCCCCC;">Aşağıdan Hesabına Giriş Şifreni Değiştirebilirsin.</td>
					</tr>
					<tr height="30">
		...
		<td width="545" valign="top"><table width="545" align="center" border="0" cellpadding="0" cellspacing="0">
			...
			<tr height="30">
				<td colspan="2" valign="top" style="border-bottom: 1px solid #CCCCCC;">Çalışma ve İşleyiş Açıklaması.</td>
			</tr>
			<tr height="5">
